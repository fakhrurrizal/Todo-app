...
export default function DeleteActivity({ data, show,handleClose, setConfirmDeleteActivity}) {
  const handleDelete = () => {
    setConfirmDeleteActivity(true)
  }
  const [open, setOpen] = useState(true)
  console.log("apay", data);
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 ">
                      ...
                      <div className="mt-2 ml-10 mb-5">
                        <span className="text-[18px] font-avanir  text-black">
                            <p>Apakah anda yakin menghapus List Activity</p> 
